    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title">Add Mentorship</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                ...
                @endif
                <form action="{{route('add_edit_membership_page')}}" method="POST">@csrf
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="m-t-20 text-center">
                        <button class="btn btn-primary submit-btn" type="submit">Add Mentorship</button>
                    </div>
                </form>
            </div>
        </div>
